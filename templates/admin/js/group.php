...
<script type="text/template" id="tmpl-tgwc-group">
		...
		<div class="tgwc-tabs-panel-header">
			<div class="header">
				<div class="header-left">
					<div class="type type-group" >
						<?php Icon::get_svg_icon( 'tgwc-group', true ); ?>
					</div>
					<h2>{{data.text}}</h2>
				</div>
			</div>
	...
	<div class="group settings-table">
		<div class="settings-table-wrapper">

				<!-- Label -->
				<div class="row">
					<div class="col-label">
						<p><?php esc_html_e( 'Group Label', 'customize-my-account-page-for-woocommerce' ); ?></p>
						<span data-toggle="tgwc-tooltip" title="<?php esc_attr_e( 'The display name shown for this group in the My Account menu.', 'customize-my-account-page-for-woocommerce' ); ?>">
				...
				<div class="row">
					<div class="col-label">
						<p><?php esc_html_e( 'Group Icon', 'customize-my-account-page-for-woocommerce' ); ?></p>
						<span data-toggle="tgwc-tooltip" title="<?php esc_attr_e( 'Choose or upload an icon to display for this group on the My Account page.', 'customize-my-account-page-for-woocommerce' ); ?>">
							<?php Icon::get_svg_icon( 'tooltip', true ); ?>
						</span>
					</div>
					<div class="col-input">
				...
				<div class="row">
					<div class="col-label">
						...
						<span data-toggle="tgwc-tooltip" title="<?php esc_attr_e( 'Choose which types of users (e.g., customers, shop managers, or administrators) can view this group.', 'customize-my-account-page-for-woocommerce' ); ?>">
							<?php Icon::get_svg_icon( 'tooltip', true ); ?>
						</span>
					</div>
					<div class="col-input">
