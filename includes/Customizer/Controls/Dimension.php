<?php
/**
 * Customize API: Dimension control class
 *
...
class Dimension extends \WP_Customize_Control {
	...
	/**
	 * ThemeGrill\WoocommerceCustomizer\Customizer\Controls\Dimension constructor.
	 *
...
<span class="description <?php echo tgwc_is_astra_active() ? 'tgwc-customize-control-description' : 'customize-control-description'; ?>">{{{ data.description }}}</span>		<# } #>
	...
	public function get_default_inputs() {
		return array(
			'top'    => esc_attr__( 'Top', 'customize-my-account-page-for-woocommerce' ),
			'right'  => esc_attr__( 'Right', 'customize-my-account-page-for-woocommerce' ),
			'bottom' => esc_attr__( 'Bottom', 'customize-my-account-page-for-woocommerce' ),
			'left'   => esc_attr__( 'Left', 'customize-my-account-page-for-woocommerce' ),
		);
	}
}
